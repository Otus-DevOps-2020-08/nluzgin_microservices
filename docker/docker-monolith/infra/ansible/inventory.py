...
def get_instance_ip_by_name(name, instances):
    ...
    ip_list = [access_config.get('natIP') for instance in instances
               if instance.get('name').startswith(name)
...
#     """
#
#     env_var_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'environments/prod/group_vars', 'app')
#
